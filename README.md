...
<img width="1546" height="857" alt="image" src="https://github.com/user-attachments/assets/14e1fb90-112e-46d4-8e91-a77890b40357" />
...
2. **⚙️ Process Analysis:**
   ...
   **Detection Query (KQL):**
   ...
   | order by Timestamp desc
   ```
<img width="1515" height="806" alt="image" src="https://github.com/user-attachments/assets/c8cfdcbb-811c-4ca2-b30a-8456472dcff9" />


3. **🌐 Network Check:**
   - **Observed Behavior:** I pivoted to the `DeviceProcessEvents` table to see if we could see anything that was suspicious around the time the port scan started. We noticed a PowerShell script named `portscan.ps1` launched at `2025-09-28T04:36:49.6856804Z`.
...
```
<img width="1512" height="801" alt="image" src="https://github.com/user-attachments/assets/e9f6a8bf-d375-4a8f-bb4d-3277dfe9549a" />
...
<img width="1349" height="723" alt="image" src="https://github.com/user-attachments/assets/1e734860-2ffe-40d1-b4c9-7063719b98c4" />
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `September 2025`  | `Joshua Schlegel`   
